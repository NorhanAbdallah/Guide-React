...
class ServiceDetails extends React.Component {
  ...
  componentDidMount() {
    console.log("resturant data : ", this.props.location.state.Restaurant)
  ...
  getUserData() {
    ...
    axios.get(uri, {
      ...
      .then(response => {
        ...
        }, () => { console.log("response of user ::: ", response.data.user) })
      })
      .catch(error => {
      ...
      <div>
        ...
        <div className="ContainerStyle">
          ...
          <div className="py-3 px-5  ServiceTitle" data-aos="flip-down" data-aos-duration="300">
            ...
            <div>
              <a href={`tel:${this.state.USERbYiD.phone}`}> <i className="fa fa-phone-alt mx-2 p-3" style={{ backgroundColor: '#F2F2F2', borderRadius: '50%', padding: '10px', color: 'green' }}></i></a>
          ...
          {/* Start of About Us */}
          <div style={{ backgroundColor: '#F5F5F5', borderRadius: '20px' }} className="px-5 py-4 my-5 " data-aos="zoom-in" data-aos-delay="400">
            ...
            {this.state.IdeaData.length > 0 ||
              ...
              <Row >
                ...
                <Col lg="5" xs="12" md="12">
                  <div className="m-0 a4lanDiv py-4" style={{ borderRadius: '30px', width: '100%', height: '300px' }}>
                    <img src={a3lanImg} alt="img" className="" style={{ height: 'auto !important' }} />
                  </div>
                </Col>
              ...
              <div className="a3lanAndBranchDiv" style={{ margin: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                {this.state.USERbYiD && this.state.USERbYiD.type === "ELECTRONIC_TRADING" ?
                  <img src={a3lanImg} alt="img" className="" style={{ height: 'auto !important' }} />
                  :
                  null}
          ...
          <div className="ServiceDetailsWorkingHours py-4 px-5 my-5" data-aos="fade-right" data-aos-delay="400">
            <Row>
